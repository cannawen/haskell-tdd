...
spec = do 
  ...
  describe "machine2" $ do
    it "works?" $ do
      ...
      machine2 "[#.#..#] (1,3) (3,4) (0,3,5) (1,2,3,4) (0,2,5) (0,1) (2,5) {44,35,48,43,24,44}" `shouldBe` 80
      machine2 "[#######..] (1,5,6,7,8) (2,5) (0,1,2,3,5,8) (0,1,2,5,7) (1,2,3,4,7) (3,4,6,7) (1,3,4) (1,2,3,4,6,8) (8) (0,1,2,3,4,5,6) {36,103,79,85,68,62,43,60,168}" `shouldBe` 243
      machine2 "[#..#.#..##] (0,3,4,5,6,9) (1,5,8,9) (0,5,8,9) (2,4) (0,1,3,5,6,7,8,9) (1,3,4,7,8) (1,2,4,6,7,8,9) (2,3,4,5,6,7,8,9) (1,2,3,4,6,8,9) {30,56,58,75,79,52,77,53,76,81}" `shouldBe` 99